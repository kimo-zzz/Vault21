...
def main():
    ...
    #LuaDefinedFunctions
    MakeEnum("Functions", [
        ["GetGameMode", FindFunctionByPatternStartEA("8B 41 24 C3")],
        ["AddBuffCounter", FindFunctionByPatternStartEA("83 EC 08 8D 44 24 0C 56 50")],
        ["GetPosition", FindFunctionByPatternStartEA("8D 44 24 08 56 50 E8 ? ? ? ? 8B F0")],
        ["SetPosition", FindFunctionByPatternStartEA("83 EC 0C 8D 44 24 10 56 57")],
        ["FacePosition", FindFunctionByPatternStartEA("83 EC 24 8D 44 24 28 56")],
        ["IncPosition", FindFunctionByPatternStartEA("83 EC 18 56 8D 44 24 20")],
        ["GetNormalizedPositionDelta", FindFunctionByPatternStartEA("83 EC 18 8D 44 24 28")],
        ["Multiply3dPointByScalar", FindFunctionByPatternStartEA("83 EC 14 68 ? ? ? ? FF 74 24 20")],
        ["DistPoint3DSegment3D", FindFunctionByPatternStartEA("8B 44 24 14 83 EC 24")],
        ["Add3dPoints", FindFunctionByPatternStartEA("83 EC 20 68 ? ? ? ? FF 74 24 2C")],
        ["GetTeamID", FindFunctionByPatternStartEA("8D 44 24 04 50 E8 ? ? ? ? 83 C4 04 85 C0 74 04 8B 40 4C")],
        ["GetID", FindFunctionByPatternStartEA("8D 44 24 04 50 E8 ? ? ? ? 83 C4 04 85 C0 74 04 8B 40 20")],
        ["MakeSay", FindFunctionByPatternStartEA("8D 44 24 04 50 E8 ? ? ? ? 50 E8 ? ? ? ? 83 C4 08 C3")],
        ["GetHQType", FindFunctionByPatternStartEA("FF 74 24 08 FF 74 24 08 E8 ? ? ? ? 83 C4 08 85 C0 75 04")],
        ["GetDampenerType", FindFunctionByPatternStartEA("74 0C 8B CE E8 ? ? ? ? 03 46 4C")],
        ["IsClone", FindFunctionByPatternStartEA("FF 74 24 08 FF 74 24 08 E8 ? ? ? ? 83 C4 08 85 C0 74 45")],
        ["IsObjectHero", FindFunctionByPatternStartEA("FF 74 24 08 FF 74 24 08 E8 ? ? ? ? 83 C4 08 85 C0 75 03 32 C0 C3 8D 4C 24 04 E8 ? ? ? ? 50 E8 ? ? ? ? 83 C4 04 84 C0 0F 95 C0 C3 CC FF 74 24 08 FF 74 24 08 E8 ? ? ? ? 83 C4 08 85 C0 75 03 32 C0 C3 8D 4C 24 04 E8 ? ? ? ? 50 E8 ? ? ? ? 83 C4 04 84 C0 0F 95 C0 C3 CC 8B D1")],
        ["IsObjectAI", FindFunctionByPatternStartEA("FF 74 24 08 FF 74 24 08 E8 ? ? ? ? 83 C4 08 85 C0 75 03 32 C0 C3 8D 4C 24 04 E8 ? ? ? ? 50 E8 ? ? ? ? 83 C4 04 84 C0 0F 95 C0 C3 CC FF 74 24 08 FF 74 24 08 E8 ? ? ? ? 83 C4 08 85 C0 75 03 32 C0 C3 8D 4C 24 04 E8 ? ? ? ? 50 E8 ? ? ? ? 83 C4 04 84 C0 0F 95 C0 C3 CC 8B D1")],
        ["IsObjectMarker", FindFunctionByPatternStartEA("FF 74 24 08 FF 74 24 08 E8 ? ? ? ? 83 C4 08 85 C0 75 03 32 C0 C3 8D 4C 24 04 E8 ? ? ? ? 50 E8 ? ? ? ? 83 C4 04 84 C0 0F 95 C0 C3 CC 8B D1")],
        ["IsTurretAI", FindFunctionByPatternStartEA("FF 74 24 08 FF 74 24 08 E8 ? ? ? ? 83 C4 08 85 C0 75 03 32 C0 C3 8D 4C 24 04 E8 ? ? ? ? 50 E8 ? ? ? ? 83 C4 04 84 C0 0F 95 C0 C3 CC 8A 81 ? ? ? ?")],
        ["IsStructure", FindFunctionByPatternStartEA("FF 74 24 08 FF 74 24 08 E8 ? ? ? ? 83 C4 08 85 C0 75 03 32 C0 C3 8D 4C 24 04 E8 ? ? ? ? 50 E8 ? ? ? ? 83 C4 04 C3")],
        ["GetObjectLaneId", FindFunctionByPatternStartEA("FF 74 24 08 FF 74 24 08 E8 ? ? ? ? 83 C4 08 85 C0 74 24")],
        ["GetTurretPosition", FindFunctionByPatternStartEA("FF 74 24 08 FF 74 24 08 E8 ? ? ? ? 83 C4 08 85 C0 74 1D")],
        ["GetLinkedBarrack", FindFunctionByPatternStartEA("56 8B 74 24 08 8B CE E8 ? ? ? ? FF 35 ? ? ? ?")],
        ["GetDampener", FindFunctionByPatternStartEA("56 57 FF 74 24 14 FF 74 24 14")],
        ["IsDampener", FindFunctionByPatternStartEA("FF 74 24 08 FF 74 24 08 E8 ? ? ? ? 83 C4 08 85 C0 75 03 32 C0 C3 8D 4C 24 04 E8 ? ? ? ? 50 E8 ? ? ? ? 83 C4 04 84 C0 0F 95 C0 C3 CC 83 EC 0C")],
        ["IsHQ", FindFunctionByPatternStartEA("FF 74 24 08 FF 74 24 08 E8 ? ? ? ? 83 C4 08 85 C0 75 03 32 C0 C3 8D 4C 24 04 E8 ? ? ? ? 50 E8 ? ? ? ? 83 C4 04 84 C0 0F 95 C0 C3 CC 8A 41 08")],
        ["IsMutatorEnabled", FindFunctionByPatternStartEA("FF 74 24 04 8B 0D ? ? ? ? E8 ? ? ? ? C3 FF 74 24 08")],
        ["GetMutatorParameterFloat", FindFunctionByPatternStartEA("83 EC 20 A1 ? ? ? ? 33 C4 89 44 24 1C 56 8B 74 24 28 8B D6")],
        ["GetMutatorParameterInt", FindFunctionByPatternStartEA("8B 4C 24 08 42 8B C1 81 FA ? ? ? ? 72 10 8B 49 FC 83 C2 23 2B C1 83 C0 FC 83 F8 1F 77 1D 52 51 E8 ? ? ? ? 83 C4 08 8B 4C 24 20 8B C6")],
        ["GetMutatorParameterBool", FindFunctionByPatternStartEA("83 EC 1C A1 ? ? ? ? 33 C4 89 44 24 18 53 56 8B 74 24 28 8B D6")],
        ["GetMutatorParameterString", FindFunctionByPatternStartEA("83 EC 34 A1 ? ? ? ? 33 C4 89 44 24 30 64 A1 ? ? ? ? 8B 0D ? ? ? ? 56")],
        ["SetDampenerState", FindFunctionByPatternStartEA("8D 4C 24 04 E8 ? ? ? ? 84 C0 75 25")],
        ["SetDampenerRespawnAnimationDuration", FindFunctionByPatternStartEA("8D 4C 24 04 E9 ? ? ? ? CC CC CC CC CC CC")],
        ["GetLane", FindFunctionByPatternStartEA("8D 44 24 04 56 50 E8 ? ? ? ? 8B F0")],
        ["EndGame", FindFunctionByPatternStartEA("8B 0D ? ? ? ? 8B 44 24 04 89 41 0C")],
        ["InitTimer", FindFunctionByPatternStartEA("51 53 55 8B 6C 24 10 33 DB")],
        ["AssignTeamGold", FindFunctionByPatternStartEA("8B 0D ? ? ? ? 57 E8 ? ? ? ? 8B F8 85 FF 0F 84 ? ? ? ? 53")],
        ["InitNeutralMinionTimer", FindFunctionByPatternStartEA("83 EC 28 8B 0D ? ? ? ? E8 ? ? ? ?")],
        ["CreateNeutralCamp", FindFunctionByPatternStartEA("8D 4C 24 04 E9 ? ? ? ? CC CC CC CC CC CC")],
        ["SpawnNeutralMinion", FindFunctionByPatternStartEA("8D 4C 24 04 E9 ? ? ? ? CC CC CC CC CC CC")],
        ["SpawnNeutralMinionWithSkin", FindFunctionByPatternStartEA("8D 4C 24 04 E9 ? ? ? ? CC CC CC CC CC CC")],
        ["LoadLevelScriptIntoScript", FindFunctionByPatternStartEA("8B 0D ? ? ? ? E8 ? ? ? ? 8B 0D ? ? ? ? 50 E8 ? ? ? ?")],
        ["GetTurret", FindFunctionByPatternStartEA("53 8B 5C 24 08 8B CB 55 56 57 E8 ? ? ? ? A1 ? ? ? ?")],
        ["GetBarracks", FindFunctionByPatternStartEA("56 8B 74 24 08 8B CE E8 ? ? ? ? FF 74 24 10")],
        ["SetDisableMinionSpawn", FindFunctionByPatternStartEA("FF 74 24 08 FF 74 24 08 E8 ? ? ? ? 83 C4 08 85 C0 74 29")],
        ["GetHQ", FindFunctionByPatternStartEA("56 8B 74 24 08 8B CE E8 ? ? ? ? FF 74 24 0C")],
        ["GetTutorialPlayer", FindFunctionByPatternStartEA("56 8B 74 24 08 8B CE E8 ? ? ? ? 8B 0D ? ? ? ?")],
        ["GetPlayerByClientID", FindFunctionByPatternStartEA("83 EC 08 53 8B 5C 24 10 8B CB 55")],
        ["PreloadCharacter", FindFunctionByPatternStartEA("6A 00 FF 74 24 08 E8 ? ? ? ? 83 C4 08 C3 CC 56")],
        ["PreloadCharacterWithSkinID", FindFunctionByPatternStartEA("E9 ? ? ? ? CC CC CC CC CC CC CC CC CC CC CC 81 EC ? ? ? ? A1 ? ? ? ? 33 C4 89 84 24 ? ? ? ? 55")],
        ["PreloadSpell", FindFunctionByPatternStartEA("FF 74 24 04 FF 35 ? ? ? ? E8 ? ? ? ? 83 C4 08")],
        ["Spell::Lua::GetHashedGameObjName", FindFunctionByPatternStartEA("68 ? ? ? ? FF 74 24 08 E8 ? ? ? ? 83 C4 08 C3 CC CC CC CC CC CC CC CC CC CC CC CC CC CC A1 ? ? ? ?")],
        ["SetLaneAffinity", FindFunctionByPatternStartEA("A1 ? ? ? ? 53 56 8B 70 04")],
        ["CreateChildTurret", FindFunctionByPatternStartEA("FF 74 24 14 8B 0D ? ? ? ? FF 74 24 14 FF 74 24 14 FF 74 24 14")],
        ["GetEoGUseNexusDeathAnimation", FindFunctionByPatternStartEA("E9 ? ? ? ? CC CC CC CC CC CC CC CC CC CC CC 8B 44 24 04 8B 91 ? ? ? ?")],
        ["GetEoGPanToHQTime", FindFunctionByPatternStartEA("E9 ? ? ? ? CC CC CC CC CC CC CC CC CC CC CC E9 ? ? ? ? CC CC CC CC CC CC CC CC CC CC CC 8B 44 24 04")],
        ["GetEoGNexusChangeSkinTime", FindFunctionByPatternStartEA("E9 ? ? ? ? CC CC CC CC CC CC CC CC CC CC CC E9 ? ? ? ? CC CC CC CC CC CC CC CC CC CC CC E9 ? ? ? ? CC CC CC CC CC CC CC CC CC CC CC 8B 44 24 04")],
        ["PauseGame", FindFunctionByPatternStartEA("8B 0D ? ? ? ? 6A 02 E8 ? ? ? ? C3 CC CC 56")],
        ["ResumeGame", FindFunctionByPatternStartEA("8B 0D ? ? ? ? 6A 00 E8 ? ? ? ? C3 CC CC 51")],
        ["GetTime", FindFunctionByPatternStartEA("8B 0D ? ? ? ? 8B 49 08 E9 ? ? ? ?")],
    ])
    # Spoof Returns
    MakeEnum("Offsets", [
