...
namespace Instalog
{
	namespace SystemFacades
	{
		...
		public:
			...
			static std::exception_ptr FromLastError() noexcept;

			/// Gets the supplied error as an exception_ptr.
			/// @return The supplied error as an exception_ptr.
			static std::exception_ptr FromWinError(DWORD errorCode) noexcept;
			...
			//static std::exception_ptr FromNtError(NTSTATUS errorCode) noexcept;
