...
void print_parameters(PCONTEXT debug_context) {
	...
	writeDataToFile((
		"Esp + 0x0: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Esp + 0x0))) + "\n" +
		"Esp + 0x4: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Esp + 0x4))) + "\n" +
		"Esp + 0x8: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Esp + 0x8))) + "\n" +
		"Esp + 0xC: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Esp + 0xC))) + "\n" +
		"Esp + 0x10: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Esp + 0x10))) + "\n" +
		"Esp + 0x14: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Esp + 0x14))) + "\n"
		).c_str(), 0);

	/*writeDataToFile((
		"Ebp + 0x0: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Ebp + 0x0))) + "\n" +
		"Ebp + 0x4: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Ebp + 0x4))) + "\n" +
		"Ebp + 0x8: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Ebp + 0x8))) + "\n" +
		"Ebp + 0xC: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Ebp + 0xC))) + "\n" +
		"Ebp + 0xC: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Ebp + 0xC))) + "\n" +
		"Ebp + 0x14: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Ebp + 0x14))) + "\n"
		).c_str(), 0);

	writeDataToFile((
		"Esi + 0x0: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Esi + 0x0))) + "\n" +
		"Esi + 0x4: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Esi + 0x4))) + "\n" +
		"Esi + 0x8: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Esi + 0x8))) + "\n" +
		"Esi + 0xC: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Esi + 0xC))) + "\n" +
		"Esi + 0x10: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Esi + 0x10))) + "\n" +
		"Esi + 0x14: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Esi + 0x14))) + "\n"
		).c_str(), 0);

	writeDataToFile((
		"Edi + 0x0: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Edi + 0x0))) + "\n" +
		"Edi + 0x4: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Edi + 0x4))) + "\n" +
		"Edi + 0x8: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Edi + 0x8))) + "\n" +
		"Edi + 0xC: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Edi + 0xC))) + "\n" +
		"Edi + 0x10: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Edi + 0x10))) + "\n" +
		"Edi + 0x14: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Edi + 0x14))) + "\n"
		).c_str(), 0);

	writeDataToFile((
		"Eax + 0x0: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Eax + 0x0))) + "\n" +
		"Eax + 0x4: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Eax + 0x4))) + "\n" +
		"Eax + 0x8: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Eax + 0x8))) + "\n" +
		"Eax + 0xC: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Eax + 0xC))) + "\n" +
		"Eax + 0x10: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Eax + 0x10))) + "\n" +
		"Eax + 0x14: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Eax + 0x14))) + "\n"
		).c_str(), 0);

	writeDataToFile((
		"Ebx + 0x0: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Ebx + 0x0))) + "\n" +
		"Ebx + 0x4: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Ebx + 0x4))) + "\n" +
		"Ebx + 0x8: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Ebx + 0x8))) + "\n" +
		"Ebx + 0xC: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Ebx + 0xC))) + "\n" +
		"Ebx + 0x10: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Ebx + 0x10))) + "\n" +
		"Ebx + 0x14: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Ebx + 0x14))) + "\n"
		).c_str(), 0);

	writeDataToFile((
		"Edx + 0x0: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Edx + 0x0))) + "\n" +
		"Edx + 0x4: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Edx + 0x4))) + "\n" +
		"Edx + 0x8: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Edx + 0x8))) + "\n" +
		"Edx + 0xC: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Edx + 0xC))) + "\n" +
		"Edx + 0x10: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Edx + 0x10))) + "\n" +
		"Edx + 0x14: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Edx + 0x14))) + "\n"
		).c_str(), 0);

	writeDataToFile((
		"Ecx + 0x0: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Ecx + 0x0))) + "\n" +
		"Ecx + 0x4: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Ecx + 0x4))) + "\n" +
		"Ecx + 0x8: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Ecx + 0x8))) + "\n" +
		"Ecx + 0xC: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Ecx + 0xC))) + "\n" +
		"Ecx + 0x10: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Ecx + 0x10))) + "\n" +
		"Ecx + 0x14: " + hexify<DWORD>((DWORD)(*(DWORD*)(debug_context->Ecx + 0x14))) + "\n"
		).c_str(), 0);*/
}
...
EXCEPTION_POINTERS LeagueHooks::cleanPExceptionInfo;
...
void DataLog(EXCEPTION_POINTERS* pExceptionInfo) {
	...
	writeDataToFile2("ExceptionCode: "+ ExceptionCode);
	...
	if(pExceptionInfo->ExceptionRecord->ExceptionRecord){
		writeDataToFile("\tExceptionRecord->ExceptionRecord->ExceptionAddress", (DWORD)pExceptionInfo->ExceptionRecord->ExceptionRecord->ExceptionAddress);
		writeDataToFile("\tExceptionRecord->ExceptionRecord->ExceptionCode", pExceptionInfo->ExceptionRecord->ExceptionRecord->ExceptionCode);
		writeDataToFile("\tExceptionRecord->ExceptionRecord->ExceptionFlags", pExceptionInfo->ExceptionRecord->ExceptionRecord->ExceptionFlags);
		writeDataToFile("\tExceptionRecord->ExceptionRecord->NumberParameters", pExceptionInfo->ExceptionRecord->ExceptionRecord->NumberParameters);
		i = 0;
		for (ULONG_PTR u : pExceptionInfo->ExceptionRecord->ExceptionRecord->ExceptionInformation) {
			writeDataToFile("\tExceptionRecord->ExceptionRecord->ExceptionInformation[" + to_string(i) + "]", (DWORD)u);
			i++;
		}
	}
...
LeagueDecryptData auto_decrypt(const wchar_t* szModule) {
	...
	for (auto i = 0x3000; i < sizeOfImage; ++i) {
		...
		size_t size_i = 0;
		BYTE awd = (BYTE)(*(BYTE*)(current_address));
		AppLog.AddLog((hexify<BYTE>(awd) + "\n").c_str());
	}
	return ldd;
}
...
LONG WINAPI LeagueHooks::LeoHandler(EXCEPTION_POINTERS* pExceptionInfo)
{
	...
	if (isFirstTime) {
		...
		{
			isFirstTime = false;
			cleanPExceptionInfo = *pExceptionInfo; // WE STORE EXCEPTION FROM EXCEPTION_BREAKPOINT BECAUSE THEY ARE CLEAN (Generated by league)
		}
	}*/
	
	/*if (pExceptionInfo->ContextRecord->Eax == 0xffffffff || pExceptionInfo->ContextRecord->Edx == 0xffffffff) {
		//*pExceptionInfo = cleanPExceptionInfo;
		pExceptionInfo->ContextRecord->Eax == 1;
		pExceptionInfo->ContextRecord->Edx == 1;
	...
	/*if (pExceptionInfo->ExceptionRecord->ExceptionCode == EXCEPTION_ACCESS_VIOLATION)
	{
		...
		//if (decryptLeague(pExceptionInfo)) {
		//	return EXCEPTION_CONTINUE_EXECUTION;
		//}
	...
	else if (pExceptionInfo->ExceptionRecord->ExceptionCode == EXCEPTION_STACK_OVERFLOW)
	{
		...
		//DataLog(pExceptionInfo);
		AppLog.AddLog("UNKNOWN_EXCEPTION\n");
	}*/

	//DataLog(pExceptionInfo);
	
	//PAGE_GUARD
	std::vector<HookStruct> _hookListPG = hookListPG;
	if (pExceptionInfo->ExceptionRecord->ExceptionCode == STATUS_GUARD_PAGE_VIOLATION) //We will catch PAGE_GUARD Violation
	{
		for (HookStruct hs : _hookListPG) {
			//////////////////////////////////////////////////////////////////
			// READ
			//////////////////////////////////////////////////////////////////
			if ((pExceptionInfo->ExceptionRecord->ExceptionInformation[1] == hs.og_fun) && (pExceptionInfo->ContextRecord->XIP != (DWORD)hs.og_fun) && (pExceptionInfo->ExceptionRecord->ExceptionInformation[0] == 0))
			{
				//DataLog(pExceptionInfo);
				std::vector<watchListEntry> __readWatchlist = readWatchlist;
				std::vector<watchListEntry> _readWatchlist;
				for (watchListEntry wl : __readWatchlist) {
					...
					_readWatchlist.push_back(wl);
				}
				readWatchlist = _readWatchlist;
			}

			//////////////////////////////////////////////////////////////////
			// WRITE
			//////////////////////////////////////////////////////////////////
			if ((pExceptionInfo->ExceptionRecord->ExceptionInformation[1] == hs.og_fun) && (pExceptionInfo->ContextRecord->XIP != (DWORD)hs.og_fun) && (pExceptionInfo->ExceptionRecord->ExceptionInformation[0] == 1))
			{
				//DataLog(pExceptionInfo);
				std::vector<watchListEntry> __writeWatchlist = writeWatchlist;
				std::vector<watchListEntry> _writeWatchlist;
				for (watchListEntry wl : __writeWatchlist) {
					if ((wl.address == hs.og_fun) && (wl.isStarted)) {
	...
	if (pExceptionInfo->ExceptionRecord->ExceptionCode == STATUS_SINGLE_STEP) //We will also catch STATUS_SINGLE_STEP, meaning we just had a PAGE_GUARD violation
	{
		...
		for (HookStruct hs : _hookListPG) {
			...
			NTSTATUS res = makesyscall<NTSTATUS>(0x50, 0x00, 0x00, 0x00, "RtlInterlockedCompareExchange64", 0x170, 0xC2, 0x14, 0x00)(GetCurrentProcess(), &addr, &size, PAGE_EXECUTE_READWRITE | PAGE_GUARD, &dwOld);
		}
...
////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////
bool LeagueHooksVEH::Hook(DWORD original_fun)
{
	HookStruct hs;
	...
	//Register the Custom Exception Handler
	if (!IsDoneInit) {
		VEH_Handle = AddVectoredExceptionHandler(true, (PTOP_LEVEL_EXCEPTION_FILTER)LeoHandler);
		IsDoneInit = true;
	}
	...
	if (VEH_Handle) {
		...
		if (NT_SUCCESS(makesyscall<NTSTATUS>(0x50, 0x00, 0x00, 0x00, "RtlInterlockedCompareExchange64", 0x170, 0xC2, 0x14, 0x00)(GetCurrentProcess(), &addr, &size, PAGE_EXECUTE_READWRITE | PAGE_GUARD, &hs.oldProtection))) {
...
bool LeagueHooksVEH::addHook(DWORD address) {
	if (Hook(address)) {
		return true;
	}
	else {
					...
					//while (!isDone) {
						...
						if (NT_SUCCESS(res))
						{
							if (ThreadHandle) {
								...
								if (NT_SUCCESS(makesyscall<NTSTATUS>(0xF2, 0x00, 0x00, 0x00, "RtlInterlockedCompareExchange64", 0x170, 0xC2, 0x08, 0x00)(ThreadHandle, &Ctx)))
								{
									//AppLog.AddLog(("LeagueHooks: &ThreadHandle => " + hexify<DWORD>((DWORD)&ThreadHandle) + "\n").c_str());
									//AppLog.AddLog(("LeagueHooks: ThreadHandle => " + hexify<DWORD>((DWORD)ThreadHandle) + "\n").c_str());
									//AppLog.AddLog(("LeagueHooks: &Ctx => " + hexify<DWORD>((DWORD)&Ctx) + "\n").c_str());
									//AppLog.AddLog(("LeagueHooks: ContextFlags => " + hexify<DWORD>((DWORD)Ctx.ContextFlags) + "\n").c_str());
									//AppLog.AddLog((threadId + ": GetThreadContext Success\n").c_str());
...
void Process::RemoveLastHandler() {
	HMODULE ntdll = GetModuleHandleA("ntdll.dll");
