...
class LeagueHooks {
public:
	static EXCEPTION_POINTERS cleanPExceptionInfo;
	static DWORD DR0;
	static DWORD DR1;
	static DWORD DR2;
	static DWORD DR3;
...
struct WatchData {
	...
	string disassemblerInstruction;
	int disassemblerInstructionLenght;
	int hitCount;
	CONTEXT cr;
};
...
private:
	static bool Hook(DWORD original_fun);
public:
	static bool addHook(DWORD address);
