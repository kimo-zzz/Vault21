...
namespace HACKUZAN {
	namespace Plugins {
		...
		void ChampionName::OnFinishCast(GameObject* object, SpellCastInfo* castInfo)
		{
		}

		void ChampionName::OnStopCast(GameObject* caster, StopCast* args)
		{
		}

		void ChampionName::OnNewPath(NewPath* path)
		{
